...
class SettingsOutputDTO
{
    ...
    public function __construct(int $id, int $motion_threshold, int $recording_extension, int $max_recording_duration, int $max_disk_usage_in_gb, array $detection_area_points, ?string $placeholder_image_url)
    {
        $this->id = $id;
